        ...
        <div className="bg-gray-800 border border-gray-700 rounded p-4 mb-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div className="bg-gray-900 p-3 rounded border border-gray-700 flex flex-col gap-2 justify-between">
                    <div>
                        <label className="text-[10px] font-bold text-gray-400 uppercase mb-2 block">Transposition</label>
                        <div className="flex flex-col gap-1.5">
                            <label className="flex items-start gap-2 cursor-pointer">
                                <input
                                    ...
                                    value="absolute"
                                    checked={(options.transpositionMode ?? 'absolute') === 'absolute'}
                                    onChange={() => set('transpositionMode', 'absolute' as CanonTranspositionMode)}
                                    className="mt-0.5 h-3 w-3"
                                />
                                <span className="text-[10px] text-gray-300">
                                    <span className="font-bold">Absolute</span>
                                    <span className="text-gray-500 block">All answers at same T from entry 0</span>
                                </span>
                            </label>
                            <label className="flex items-start gap-2 cursor-pointer">
                                <input
                                ...
                                <span className="text-[10px] text-gray-300">
                                    ...
                                    <span className="text-gray-500 block">Each voice adds one more T (voice × T)</span>
                                </span>
                            </label>
                        </div>
                    </div>
                    <div className="border-t border-gray-700 pt-2 mt-1">
                        <div className="flex flex-col gap-1 text-[10px] text-gray-500">
                            <span>All combinations scored.</span>
                            <span>Traditional: P4/P5/P8/m10/M10/P11/P12/P15{options.allowThirdSixth ? ' + 3rds/6ths' : ''}.</span>
